...
SOURCES = agent.c buffer.c config.c error.c kex.c options.c pcap.c socket.c auth.c callbacks.c connect.c gcrypt_missing.c kex1.c log.c packet.c pki.c string.c auth1.c channels.c crc32.c getpass.c known_hosts.c match.c packet1.c pki_crypto.c session.c threads.c base64.c channels1.c dh.c gzip.c legacy.c messages.c packet_cb.c sftp.c wrapper.c bind.c client.c ecdh.c init.c libcrypto.c misc.c packet_crypt.c poll.c

# sftpserver.c scp.c libgcrypt.c server.c pki_gcrypt.c
